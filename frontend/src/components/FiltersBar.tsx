    ...
    <div className="filters-bar">
      <div className="filter-toggle-group">
        ...
        <div className="toggle-group">
          ...
          <button
            type="button"
            className={status === 'WATCHED' ? 'toggle-chip toggle-chip-active' : 'toggle-chip'}
          ...
          <button
            type="button"
            className={status === 'WANT_TO_WATCH' ? 'toggle-chip toggle-chip-active' : 'toggle-chip'}
      ...
      <div className="filter-toggle-group">
        ...
        <div className="toggle-group">
          ...
          <button
            type="button"
            className={contentType === 'MOVIE' ? 'toggle-chip toggle-chip-active' : 'toggle-chip'}
          ...
          <button
            type="button"
            className={contentType === 'TV' ? 'toggle-chip toggle-chip-active' : 'toggle-chip'}
