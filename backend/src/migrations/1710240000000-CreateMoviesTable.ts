...
export class CreateMoviesTable1710240000000 implements MigrationInterface {
  name = 'CreateMoviesTable1710240000000';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP INDEX IF EXISTS idx_movies_title_normalized;`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS idx_movies_user_avg_rating;`,
    );
    await queryRunner.query(`DROP INDEX IF EXISTS idx_movies_watch_date;`);
